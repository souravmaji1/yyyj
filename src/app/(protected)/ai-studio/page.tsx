...
import type { Mode, SubMode, AI3State } from './types';
import StudioChat from '../../../components/ai-studio/studiochat'
  ...
  return (
    <div className="min-h-screen bg-[#0b0f1a] text-white">
      ...
      <main className="mx-auto max-w-[1600px] px-4 sm:px-6 lg:px-8 pt-6 sm:pt-8 md:pt-10" id="main-content">
        ...
        {/* Main Content Grid */}
        <section className="grid gap-6 md:gap-8 xl:grid-cols-12 mt-12" aria-label="AI Generation Interface">
